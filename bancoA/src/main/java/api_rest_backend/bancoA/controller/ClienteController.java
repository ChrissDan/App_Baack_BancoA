package api_rest_backend.bancoA.controller;

import api_rest_backend.bancoA.model.Cliente;
import api_rest_backend.bancoA.service.ClienteService;
...
@RestController
@RequestMapping("/bancoa/api/clientes")
@CrossOrigin(origins = "http://https://app-front-banco-a.vercel.app")
